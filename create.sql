CREATE TABLE IF NOT EXISTS odontologos(id INT AUTO_INCREMENT PRIMARY KEY, matricula INT NOT NULL, nombre VARCHAR(50) NOT NULL, apellido VARCHAR(50) NOT NULL);
